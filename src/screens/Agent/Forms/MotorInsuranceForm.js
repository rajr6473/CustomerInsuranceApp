...
export default function MotorInsuranceForm(props) {
    ...
    <ScrollView style={formStyles.container}>
      ...
      {formStep === 1 && (
        <>
          ...
          <TextInput placeholder="Vehical Type" value={formData.vehicalType} onChangeText={text => handleChange('vehicalType', text)} style={formStyles.input} />
          <TextInput placeholder="Insurance Type" value={formData.insuranceType} onChangeText={text => handleChange('insuranceType', text)} style={formStyles.input} />
