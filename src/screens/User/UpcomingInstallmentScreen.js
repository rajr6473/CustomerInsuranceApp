...
export default function UpcomingInstallmentScreen(){
...
useEffect(()=>{ api.getUserDashboard(auth.getToken()).then(d=>setItems(d.upcomingInstallment)).catch(()=>{}) },[]);


return (
<SafeAreaView style={{flex:1, padding:16}}>
<Text style={{fontSize:20,fontWeight:'700', marginBottom:12}}>Upcoming Installment</Text>
<FlatList
        data={policies}
